...
public class ConnectionStreet {
        public static void main(String[] args) {
            ...
            p5n.SetName("p5n");
            p5n.Value = new TransferOperation("localhost", "1092", "P_a1");
            ...
            t0.InputPlaceName.add("P_4N");

            Condition T0Ct1 = new Condition(t0,"P_4N", TransitionCondition.NotNull);
            ...
            grdT0.Activations.add(new Activation(t0, "P_4N", TransitionOperation.AddElement,"p1"));
            ...
            Condition T6Ct1 = new Condition(t6,"p7", TransitionCondition.NotNull);
            ...
            grdT7.Activations.add(new Activation(t7, "p8", TransitionOperation.AddElement,"p2"));
